...
const dict = {
  ...
  totalStudy: { en: "Total Study Time", mn: "Нийт суралцсан хугацаа" },
  minutesToday: { en: "minutes today", mn: "минут өнөөдөр" },
  timerAutomatic: { en: "Timer runs automatically when app is active", mn: "Хэмжээ идэвхтэй байх үед автоматаар ажилладаг" },
  ...
  correctAnswer: { en: "Correct answer", mn: "Зөв хариулт" },
